...
export const SYMBOLS: Record<SymbolType, SymbolConfig> = {
  [SymbolType.SCATTER]: { id: SymbolType.SCATTER, label: 'Scatter', color: 'text-yellow-400', isHighValue: true, icon: '🪙' },
  [SymbolType.WILD]:    { id: SymbolType.WILD,    label: 'Wild',    color: 'text-orange-500', isHighValue: true, icon: '🌅' },
  [SymbolType.BONUS]:   { id: SymbolType.BONUS,   label: 'Bonus',   color: 'text-purple-400', isHighValue: true, icon: '⛩️' },
  [SymbolType.ORB]:     { id: SymbolType.ORB,     label: 'Orb',     color: 'text-cyan-300',   isHighValue: true, icon: '🔮' },
  [SymbolType.BUFFALO]: { id: SymbolType.BUFFALO, label: 'Buffalo', color: 'text-red-600',    isHighValue: true, icon: '🐃' },
  [SymbolType.EAGLE]:   { id: SymbolType.EAGLE,   label: 'Eagle',   color: 'text-blue-400',   isHighValue: true, icon: '🦅' },
  [SymbolType.WOLF]:    { id: SymbolType.WOLF,    label: 'Wolf',    color: 'text-gray-300',   isHighValue: true, icon: '🐺' },
  [SymbolType.COUGAR]:  { id: SymbolType.COUGAR,  label: 'Cougar',  color: 'text-yellow-700', isHighValue: true, icon: '🐆' },
...
// Currently optimized for approx 1/120 Bonus/Feature hit rate.
...
export const REEL_STRIPS: SymbolType[][] = [
  [
    ...
    SymbolType.BUFFALO, SymbolType.Q, SymbolType.NINE, SymbolType.BONUS, SymbolType.J, SymbolType.BONUS, SymbolType.A, SymbolType.K, SymbolType.WOLF
  ],
  [
  ...
  [
    ...
    SymbolType.J, SymbolType.K, SymbolType.TEN, SymbolType.Q, SymbolType.BONUS, SymbolType.A, SymbolType.COUGAR, SymbolType.NINE
  ],
  [
    ...
    SymbolType.TEN, SymbolType.Q, SymbolType.K, SymbolType.A, SymbolType.BONUS, SymbolType.J, SymbolType.WOLF, SymbolType.NINE
  ],
];
